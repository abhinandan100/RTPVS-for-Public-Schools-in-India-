...
S_indoor_bulb = School.Appliance(School, 60,9,1,120,0.1,120,occasional_use=0.5)
...
S_ceilingfan= School.Appliance(School,60,35,1,300,0.2,300)
...
S_lunch= School.Appliance(School, 1,8000,2,60,0.1,30, thermal_P_var = 0.2)
S_lunch.windows([600,645],[645,690],0.1)
